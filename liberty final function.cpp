...
void displaycart(int sum,int a, cart c[20])
{
	...
	{
		cout << "------------------------------------------------------------------------------------------------------------------------" << endl;
		cout << "Name of Book : " << k + 1 << "  " << cartbooks1[k] << "\n" << "Price : " << cartprice[k] << "\n" << "Quantity : " << cartquantity[k] << "\n" << cartquantity[k] << "*" << cartprice[k] << "\n" << "Bill : " << cartquantity[k] * cartprice[k] << endl;
		cout << "------------------------------------------------------------------------------------------------------------------------" << endl;
...
void divinfo()
{
	...
	cout<< "Dilevery Detils" << "Name:" << dfstname + " " + dlstname << "\n" << "Country:" << dcountry << "\nCity:" << dcity << "\nState:" << dregion << "\nAdeess:" << dadress << endl;
	fstream myfile;
	myfile.open("liberty.txt", ios::app);
	if (!myfile)
	{
		...
		myfile << "Dilevery Detils" << "Name:" << dfstname + " " + dlstname << "\n" << "Country:" << dcountry << "\nCity:" << dcity << "\nState:" << dregion << "\nAdeess:" << dadress << endl;
		myfile.close();
	}
